    ...
    <section className="flex flex-col lg:flex-row h-full p-6 items-center min-h-[70vh]">
      ...
      >
        ...
        <p className="text-center md:text-start text-xs md:text-base">
         I am a software engineer who enjoys creating smart and efficient software solutions. I love turning ideas into real applications that are easy to use and reliable. Learning new technologies and improving my skills is something I do every day. I am passionate about solving problems and building software that makes a positive impact.
        </p>
      ...
      <LeaveCard label="MERN Stack Developer" />
    </section>
  );
};
